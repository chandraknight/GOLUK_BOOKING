                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <ul class="list list-inline text-small">
                            @if($hotel->email)
                                ...
                                @if($hotel->website)
                                    <li><a href="http://{{$hotel->website}}" target="_blank"><i
                                                    class="fa fa-home"></i> {{$hotel->website}}</a>
                                    </li>
                                @endif
                    ...
                    <div class="col-md-3">
                        <p class="booking-item-header-price">
                            ...
                            <span class="text-lg">Rs {{$min}}</span>/night
                        </p>
                    </div>
                </div>
            </header>
                                    ...
                                    @foreach($photos as $photo)
                                        <div class="col-md-2">
                                            ...
                                            <a class="hover-img popup-gallery-image"
                                               href="{{url('/')}}/storage/hotel_photos/{{$hotel->id}}/{{$photo->photo}}"
                                               data-effect="mfp-zoom-out">
                                                <img src="{{url('/')}}/storage/hotel_photos/{{$hotel->id}}/{{$photo->photo}}"
                                                     alt="Image Alternative text"
                                                     title="hotel PORTO BAY SERRA GOLF living room"><i
            ...
            <div class="row">
                                ...
                                <li>
                                    ...
                                    <div class="row booking-item">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <ul class="booking-item-features booking-item-features-sign clearfix">
                                                <li rel="tooltip" data-placement="top" title="Adults Occupancy">
                                                    ...
                                                    <span class="booking-item-feature-sign">x {{$room->no_adults}}</span>
                                                </li>
                                                <li rel="tooltip" data-placement="top" title="Beds"><i
                                                            class="im im-bed"></i><span
                                                            class="booking-item-feature-sign">x {{$room->no_beds}}</span>
                                                </li>

                                            </ul>
                                            <ul class="booking-item-features booking-item-features-small clearfix">
                                                <li rel="tooltip" data-placement="top" title="Flat Screen TV"><i
                                                            class="im im-tv"></i>
                                                </li>
                                        ...
                                        <div class="col-md-3"><span
                                                    class="booking-item-price">Rs {{$room->room_flat_cost}}
                                                <small>/night</small></span>


                                            <div class="form-group form-group-sm">
                                                <h3>{{$room->roomType->name}}
                                                    <small> Room</small>
                                                </h3>
                                                ...
                                                @if(isset($room->room_flat_cost))
                                                    <div class="radio-inline checked radio-stroke">
                                                        <label>
                                                            <input class="i-radio" checked="" type="radio"
                                                                   name="plan[{{$i}}]" value="none">None
                                                            <small> Rs {{$room->room_flat_cost}}/night</small>
                                                        </label>

                                                    </div>
                                                @endif
                                                @if(isset($room->cost_ep_plan))
                                                    <div class="radio-inline radio-stroke">
                                                        <label>
                                                            <input class="i-radio" type="radio" name="plan[{{$i}}]"
                                                                   value="ep">EP
                                                            <small> Rs {{$room->cost_ep_plan}}/night</small>
                                                        </label>
                                                    </div>

                                                @endif
                                                @if(isset($room->cost_cp_plan))
                                                    <div class="radio-inline radio-stroke">
                                                        <label>
                                                            <input class="i-radio" type="radio" name="plan[{{$i}}]"
                                                                   value="cp">CP
                                                            <small> Rs {{$room->cost_cp_plan}}/night</small>
                                                        </label>
                                                    </div>
                                                @endif
                                                @if(isset($room->cost_map_plan))
                                                    <div class="radio-inline radio-stroke">
                                                        <label>
                                                            <input class="i-radio" type="radio" name="plan[{{$i}}]"
                                                                   value="map">MAP
                                                            <small> Rs {{$room->cost_map_plan}}/night</small>
                                                        </label>
                                                    </div>
                                                @endif
                                                @if(isset($room->cost_ap_plan))
                                                    <div class="radio-inline radio-stroke">
                                                        <label>
                                                            <input class="i-radio" type="radio" name="plan[{{$i}}]"
                                                                   value="ap">AP
                                                            <small> Rs {{$room->cost_ap_plan}}/night</small>
                                                        </label>
                                                    </div>
                                                @endif
                ...
                <div class="col-md-3">
                    <div class="booking-item-dates-change">
                            ...
                            <div class="booking-item-deails-date-location">
                                <ul>
                                    <li>
                                        ...
                                        <p>{{$hotel->name}}</p>
                                        <p>
                                            <i class="fa fa-map-marker box-icon-inline box-icon-gray"></i>{{$hotel->address}}
                                        </p>
                                    </li>
                                    <li>
                                        <h5>Check In:</h5>
                                    ...
                                    <li>
                                        ...
                                        <p>
                                            <i class="fa fa-male box-icon-inline box-icon-gray"></i>{{$search->no_adults}}
                                        </p>
                                    </li>
                                    @if($search->no_childs>0)
                                        <li>
                                            ...
                                            <p>
                                                <i class="fa fa-child box-icon-inline box-icon-gray"></i>{{$search->no_childs}}
                                            </p>
                                        </li>
                                    @endif
                                </ul>
                        ...
                        @else
                            <a class="btn btn-primary popup-text" href="#search-dialog" data-effect="mfp-zoom-out">Confirm
                                Details</a></small>
                        @endif
                    </div>
                </div>
