    	...
    	<div class="row">
            <div class="col-md-5">
                <form action="{{route('room.register')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="room_no" class="form-control" placeholder="Enter Room Name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="cost ap plan">Cost MAP Plan: </label>
                        <input type="text" name="cost_map_plan" class="form-control" placeholder="Enter AP plan">
                    </div>
                    <div class="form-group">
                        <label for="cost map plan">Cost AP Plan: </label>
                        <input type="text" name="cost_ap_plan" class="form-control" placeholder="Enter MAP Plan">
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-5">
                ...
                @foreach($roomservices as $roomservice)
                    <div class="checkbox">
                        <label><input class="i-check" type="checkbox" name="roomservices[]" value="{{$roomservice->id}}">{{$roomservice->name}}</label>
                    </div>
                @endforeach
