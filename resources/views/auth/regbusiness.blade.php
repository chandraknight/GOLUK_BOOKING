                                ...
                                <div class="col-md-6">
                                    ...
                                    <form method="POST" action="{{ route('businessregister') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-envelope input-icon input-icon-show"></i>
                                                    <label>Email</label>
                                                    <input class="form-control" value="{{(Auth::user())?Auth::user()->email:''}}" type="email" name="email">                                                    @if ($errors->has('email'))
                                                    <span class="invalid-feedback">
                                        ...
                                        <strong>{{ $errors->first('password') }}</strong>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                                    ...
                                                    <input class="form-control" type="text" placeholder="Phone Number" name="contact">                                                    @if ($errors->has('contact'))
                                                    <span class="invalid-feedback">
                                                ...
                                                <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                                    <label>Address</label>
                                                    <input class="form-control" type="text" placeholder="Full Address" name="address">                                                    @if ($errors->has('address'))
                                                    <span class="invalid-feedback">
                                                ...
                                                <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                                    ...
                                                    <input class="form-control" type="file" name="logo"> @if ($errors->has('user_image'))
                                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('user_image') }}</strong>
                                                ...
                                                <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                                    <label>Your Business Document</label>
                                                    <input class="form-control" type="file" name="business_certificate" multiple>                                                    @if ($errors->has('business_certificate'))
                                                    <span class="invalid-feedback">
                                        ...
                                        <input class="btn btn-primary btn-block" type="submit" value="Register Business">
                                    </form>
