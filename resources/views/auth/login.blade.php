        ...
        <div class="bg-holder full">
            ...
            <div class="bg-holder-content full text-white">
                <a class="logo-holder" href="{{route('welcome')}}">
                    <img src="{{URL::asset('img\Yatritime.png')}}" height="52" width="52" alt="Image Alternative text" title="Image Title">
                </a>
                            ...
                            <div class="col-md-4">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-envelope input-icon input-icon-show"></i>
                                        <label>Email</label>
                                        <input class="form-control" placeholder="e.g. johndoe@gmail.com" type="email" name="regemail">
                                    ...
                                    <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                        <label>Password</label>
                                        <input class="form-control" type="password" placeholder="my secret password" name="regpassword">
                                        @if ($errors->has('regpassword'))
                                            <span class="invalid-feedback">
                                        <strong>{{ $errors->first('regpassword') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                    <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                    ...
                                    <input class="btn btn-primary" type="submit" value="Sign up for Yatritime">
                                </form>
                            </div>
                        </div>
                    </div>
