                    ...
                    <div class="full-center">
                        <div class="container">
                            <div class="row row-wrap" data-gutter="60">
                                ...
                                <div class="col-md-6">
                                    <h3 class="mb15">Register as Agent</h3>
                                       <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
                                            ...
                                            <input class="form-control" value="{{(Auth::user())?Auth::user()->name:''}}" type="text" name="name">
                                            @if ($errors->has('name'))
                                        }
                                    <span class="invalid-feedback">
                                ...
                                @endif
                                        ...
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-envelope input-icon input-icon-show"></i>
                                            <label>Email</label>
                                            <input class="form-control" value="{{(Auth::user())?Auth::user()->email:''}}" type="email" name="email">
                                             @if ($errors->has('email'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('email') }}</strong>
                                    </span>
                                ...
                                @endif
                                        ...
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                            <label>Your Verified Documents</label>
                                            <input class="form-control" type="file" name="citizenship" multiple>
                                ...
                                @endif
                                        ...
                                        <input class="btn btn-primary btn-block" type="submit" value="Register as Agent">
                                    </form>                                                 
