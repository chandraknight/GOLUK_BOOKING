                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="customer_contact" type="text" value="{{old('activitytill')}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Remarks</label>
                                    <textarea class="form-control" name="remarks">{{old('customer_address')}}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <li>
                                ...
                                <ul class="booking-item-payment-price">
                                    ...
                                    <li>
                                        ...
                                        <p class="booking-item-payment-price-amount">Rs {{$vehicle->rate_per_day}}<small>/per day</small>
                                        </p>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        <p class="booking-item-payment-total">Total trip: <span>Rs {{$vehicle->rate_per_day*$days}}</span>
                                ...
                                <div class="booking-item-price-calc">
                                    <div class="row row-wrap">
                                        <div class="col-md-6">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input class="i-check" type="checkbox" name="service[]" value="{{$servicecost->vehicleService->id}}">{{$servicecost->vehicleService->service_name}}<span class="pull-right">Rs {{$servicecost->cost_per_day}}</span>
