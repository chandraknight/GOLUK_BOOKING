                    ...
                    <div class="col-md-3">
                        ...
                        <div class="booking-item-deails-date-location">
                            ...
                            <ul>
                                ...
                                <li>
                                    <h5>Pick Up:</h5>
                                    <p><i class="fa fa-map-marker box-icon-inline box-icon-gray"></i>{{$location->destination}}</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-map-marker input-icon input-icon-highlight"></i>
                                ...
                                <input class="typeahead form-control" name="location" value="{{$vehicle->location}}" placeholder="City" type="text">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-map-marker input-icon input-icon-highlight"></i>
                                <label>Drop-off To</label>
                                <input class="typeahead form-control" name="destination" placeholder="City, Airport or U.S. Zip Code" value="Same as Pick-up" type="text">
                            </div>
                        </div>
                    </div>
